...
public class NetworkUtils {
    ...
    private static final String BASE_URL = "http://test.androidcamp.bytedance.com/";
    private static String STUDENT_ID = "12345";
    private static String USER_NAME = "12345";
    ...
    public static void postVideo(Uri imageUrl, Uri videoUrl, Context context) {
        ...
        STUDENT_ID = sharedPref.getString(context.getString(R.string.sp_student_id), "12345");
        USER_NAME = sharedPref.getString(context.getString(R.string.sp_user_name), "12345");
